...
export const PROPOSAL_TEMPLATES = {
  parameter_change: {
    ...
    description: 'Propose changes to protocol parameters such as fees, limits, or timeouts.',
    quorum: 10,
    threshold: 60,
    votingDuration: 7,
  },
  treasury: {
    ...
    description: 'Propose allocation of treasury funds for grants, partnerships, or protocol development.',
    quorum: 15,
    threshold: 70,
    votingDuration: 7,
  },
