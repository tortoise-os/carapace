...
export function useTokenPrice(
  ...
  useEffect(() => {
    fetchPrice()
    // biome-ignore lint/correctness/useExhaustiveDependencies: fetchPrice intentionally not wrapped
  }, [fetchPrice])
...
export function useTokenPrices(
  ...
  useEffect(() => {
    fetchPrices()
    // biome-ignore lint/correctness/useExhaustiveDependencies: fetchPrices intentionally not wrapped
  }, [fetchPrices])
...
export function useTokenValue(
  ...
  const usdValue = Number.isNaN(amountNum) ? 0 : amountNum * price
