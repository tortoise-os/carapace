    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Connect your Sui wallet to start trading</DialogDescription>
        </DialogHeader>
        ...
        <div className="mt-4 p-3 bg-muted/50 rounded-lg">
          <p className="text-xs text-muted-foreground">
            By connecting a wallet, you agree to TortoiseSwap's Terms of Service and acknowledge
            that you have read and understand the protocol disclaimers.
          </p>
        </div>
      </DialogContent>
    </Dialog>
