  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {warning && <div className="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-yellow-500" />}
      </button>
      ...
      {isOpen && (
        <>
          {/* Backdrop */}
          {/* biome-ignore lint/a11y/useKeyWithClickEvents: Backdrop dismiss click handler is intentional */}
          {/* biome-ignore lint/a11y/noStaticElementInteractions: Backdrop is purely decorative */}
