        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <label htmlFor="swap-slippage-custom" className="text-sm font-semibold">
                Slippage Tolerance
              </label>
          ...
          {/* RPC Endpoint */}
          <div className="space-y-3">
            <label htmlFor="swap-rpc-endpoint" className="text-sm font-semibold">
              RPC Endpoint
            </label>
            <div className="flex items-center gap-2">
              <Input
            ...
            <p className="text-xs text-muted-foreground">Custom RPC endpoint for Sui network</p>
          </div>

          {/* Explorer */}
          <div className="space-y-3">
            <label htmlFor="swap-block-explorer" className="text-sm font-semibold">
              Block Explorer
            </label>
            <div className="flex items-center gap-2">
              <select
            ...
            <p className="text-xs text-muted-foreground">Choose your preferred block explorer</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Maximum gas you're willing to pay. Leave blank for automatic estimation.
            </p>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
            <div className="space-y-1">
              <label htmlFor="swap-ledger-toggle" className="text-sm font-semibold">
                Using a Ledger
              </label>
              <p className="text-xs text-muted-foreground">
