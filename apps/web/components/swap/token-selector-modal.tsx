...
function TokenRow({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: Token selection is handled by parent modal
    // biome-ignore lint/a11y/noStaticElementInteractions: Interactive token row with click handler
    <div
      className={`
            ...
            {token.priceUsd && (
              <span
                className={`text-xs font-medium ${
                  // biome-ignore lint/style/noNonNullAssertion: change24h checked above before rendering
