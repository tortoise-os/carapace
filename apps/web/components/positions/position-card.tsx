    ...
    <Card className="p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <div className="flex -space-x-2">
            <TokenIcon symbol={position.tokenXSymbol} size="md" gradient="bg-brand-gradient-ocean" />
            <TokenIcon symbol={position.tokenYSymbol} size="md" gradient="bg-brand-gradient-seafoam" />
          </div>
          <div>
      ...
      <div className="space-y-2 mb-4">
        <div className="flex justify-between items-center p-2 bg-muted/50 rounded">
          <div className="flex items-center gap-2">
            <TokenIcon symbol={position.tokenXSymbol} size="sm" gradient="bg-brand-gradient-ocean" />
        ...
        <div className="flex justify-between items-center p-2 bg-muted/50 rounded">
          <div className="flex items-center gap-2">
            <TokenIcon symbol={position.tokenYSymbol} size="sm" gradient="bg-brand-gradient-seafoam" />
