...
import { Button, Card, Input, TokenIcon } from "@carapace/carapace-ui"
  ...
  return (
    <Card className="max-w-2xl mx-auto p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        {[1, 2, 3, 4].map((s) => (
          <div key={s} className="flex items-center">
            ...
            {s < 4 && <div className={`w-16 h-1 mx-2 ${s < step ? "bg-green-500" : "bg-muted"}`} />}
          </div>
        ))}
      </div>
      ...
      <div className="min-h-[400px]">
        ...
        {step === 2 && <Step2SelectFee feeTier={feeTier} onSelectFee={setFeeTier} />}
        {step === 3 && (
          <Step3SetPrice
            // biome-ignore lint/style/noNonNullAssertion: tokenA guaranteed to exist at step 3
            tokenA={tokenA!}
            // biome-ignore lint/style/noNonNullAssertion: tokenB guaranteed to exist at step 3
            tokenB={tokenB!}
            amountA={amountA}
            amountB={amountB}
        ...
        {step === 4 && (
          <Step4Review
            // biome-ignore lint/style/noNonNullAssertion: tokenA guaranteed to exist at step 4
            tokenA={tokenA!}
            // biome-ignore lint/style/noNonNullAssertion: tokenB guaranteed to exist at step 4
            tokenB={tokenB!}
            feeTier={feeTier}
            amountA={amountA}
            amountB={amountB}
  ...
  if (loading) {
    return (
      <div>
        ...
        <p className="text-muted-foreground mb-6">Choose the two tokens for your liquidity pool</p>
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="pool-token-a" className="text-sm font-medium mb-2 block">
            Token A
          </label>
        ...
        <div>
          <label htmlFor="pool-token-b" className="text-sm font-medium mb-2 block">
            Token B
          </label>
...
function Step2SelectFee({
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-6">Choose the fee percentage for this pool</p>
        ...
        {FEE_TIERS.map((tier) => (
          ...
          >
            <div className="flex items-center justify-between mb-1">
              ...
              {feeTier === tier.value && <Check className="h-5 w-5 text-primary" />}
            </div>
        ...
        <div className="flex gap-2">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground">
              Liquidity providers earn fees on every swap. Higher fees mean more earnings but may
    ...
    <div>
      ...
      <div className="space-y-4">
        <div className="bg-muted rounded-lg p-4">
          <label htmlFor="pool-initial-price" className="text-sm font-medium mb-2 block">
        ...
        <div className="bg-muted rounded-lg p-4">
          <label htmlFor="pool-amount-a" className="text-sm font-medium mb-2 block">
        ...
        <div className="bg-muted rounded-lg p-4">
          <label htmlFor="pool-amount-b" className="text-sm font-medium mb-2 block">
      ...
      {amountA && amountB && (
        <div className="mt-6 p-4 bg-muted rounded-lg">
          ...
          <div className="text-lg font-semibold">
            1 {tokenA.symbol} = {(parseFloat(amountB) / parseFloat(amountA)).toFixed(6)}{" "}
            {tokenB.symbol}
          </div>
        </div>
      )}
...
function Step4Review({
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-6">Confirm your pool details before creating</p>
      ...
      <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
        <div className="flex gap-2">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground">
              Once created, the pool cannot be deleted. Make sure all details are correct before
              proceeding.
            </p>
          </div>
        </div>
