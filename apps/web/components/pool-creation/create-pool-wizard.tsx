...
export function CreatePoolWizard() {
	...
	const handleCreatePool = () => {
		toast.info("Pool creation coming soon", {
			description:
				"This feature will be available after smart contract deployment",
		});
	};
	...
	return (
		<Card className="max-w-2xl mx-auto p-8">
			...
			<div className="min-h-[400px]">
				...
				{step === 2 && (
					<Step2SelectFee feeTier={feeTier} onSelectFee={setFeeTier} />
				)}
				{step === 3 && (
					<Step3SetPrice
						tokenA={tokenA!}
				...
				<div className="flex gap-2">
					...
					<div className="text-sm">
						...
						<p className="text-muted-foreground">
							Liquidity providers earn fees on every swap. Higher fees mean more
							earnings but may reduce trading volume.
						</p>
					</div>
				</div>
			</div>
...
function Step4Review({
	...
	const feeTierLabel =
		FEE_TIERS.find((t) => t.value === feeTier)?.label || `${feeTier / 100}%`;
			...
			<div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
				<div className="flex gap-2">
					...
					<div className="text-sm">
						...
						<p className="text-muted-foreground">
							Once created, the pool cannot be deleted. Make sure all details
