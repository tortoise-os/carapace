        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="flex items-center gap-2 p-3 bg-muted rounded-xl">
            <div className="flex -space-x-2">
              <TokenIcon symbol={tokenXSymbol} size="sm" gradient="bg-brand-gradient-ocean" className="border-2 border-card" />
              <TokenIcon symbol={tokenYSymbol} size="sm" gradient="bg-brand-gradient-seafoam" className="border-2 border-card" />
            </div>
            <span className="font-semibold">{tokenXSymbol} / {tokenYSymbol}</span>
          </div>
              ...
              {amountX && amountY && (
                <div className="p-3 bg-muted rounded-xl space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">~{Math.sqrt(parseFloat(amountX) * parseFloat(amountY)).toFixed(6)}</span>
                  </div>
                </div>
              )}
