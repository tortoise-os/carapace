...
import { formatCurrency, useProtocolAnalytics } from "@/lib/hooks/use-analytics"
          ...
          <Card key={stat.title} className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className={`p-3 rounded-xl bg-gradient-to-br ${stat.gradient} bg-opacity-10`}>
                <Icon
                  className={`h-6 w-6 bg-gradient-to-br ${stat.gradient} bg-clip-text text-transparent`}
                />
              </div>
            </div>
          </Card>
