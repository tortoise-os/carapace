import { BlurFade, DotPattern, RetroGrid, TextAnimate } from "@carapace/carapace-ui"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <BlurFade delay={0.6}>
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto font-medium">
              Experience the future of DeFi with AI-powered adaptive fees and intelligent yield
              optimization on Sui
            </p>
          </BlurFade>
