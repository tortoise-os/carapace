        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <BlurFade delay={0.2}>
            <button className="group mb-4 px-5 py-2.5 rounded-full bg-primary/10 border border-primary/20 hover:bg-primary/20 hover:border-primary/30 hover:scale-105 transition-all duration-200 shadow-sm hover:shadow-md">
              <span className="text-sm font-semibold text-primary group-hover:text-accent transition-colors">Powered by AI & Sui Blockchain</span>
            </button>
          </BlurFade>
          ...
          <BlurFade delay={0.6}>
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto font-medium">
              Experience the future of DeFi with AI-powered adaptive fees and intelligent yield optimization on Sui
            </p>
          </BlurFade>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <BlurFade delay={0.2}>
            ...
            <p className="text-xl text-muted-foreground text-center mb-16 max-w-2xl mx-auto font-medium">
              Built for traders who demand the best in speed, security, and intelligence
            </p>
          </BlurFade>
            ...
            {[
              {
                ...
                description: "Dynamic fee adjustment based on market conditions for optimal trading costs",
                delay: 0.3,
              ...
              },
              {
                ...
                description: "Built on Sui with proven Move smart contracts and rigorous security audits",
                delay: 0.4,
              ...
              },
              {
                ...
                description: "Maximize yields with AI-driven strategies in secure TEE environments",
                delay: 0.5,
              ...
              <BlurFade key={i} delay={feature.delay}>
                <button className={`card card-hover p-8 h-full group cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-left w-full shadow-md hover:shadow-xl bg-gradient-to-br ${feature.cardGradient} hover:from-primary/10 hover:to-accent/10`}>
                  <div className={`w-14 h-14 rounded-xl ${feature.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-200 shadow-lg`}>
      ...
      <section className="relative py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "$0M+", label: "Total Value Locked", gradient: "from-accent-orange/25 to-accent-amber/20" }, // Money/value - ORANGE
              { value: "0+", label: "Active Pools", gradient: "from-accent-blue/25 to-accent-indigo/20" }, // Activity/water - BLUE
              { value: "0K+", label: "Transactions", gradient: "from-accent-purple/25 to-accent-violet/20" }, // Technology - PURPLE
              { value: "0.25%", label: "Trading Fee", gradient: "from-brand-teal/25 to-brand-cyan/20" }, // Primary feature - TEAL
            ].map((stat, i) => (
              <BlurFade key={i} delay={0.2 + i * 0.1}>
                <button className={`text-center p-6 rounded-lg bg-gradient-to-br ${stat.gradient} hover:from-primary/10 hover:to-accent/10 transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95 shadow-sm hover:shadow-lg w-full group`}>
