          ...
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Default trading parameters</p>
              </div>
            </div>
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange("defaultSlippage", e.target.value)}
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange("transactionDeadline", e.target.value)}
                    className="w-full px-3 py-2 rounded-lg border bg-background mt-2"
                  />
                </label>
                <p className="text-xs text-muted-foreground mt-1">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleChange("autoRouting", e.target.checked)}
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleChange("showBalances", e.target.checked)}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-muted peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
                </label>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleChange("txNotifications", e.target.checked)}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-muted peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
                </label>
