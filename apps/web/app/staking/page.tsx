...
export default function StakingPage() {
	...
	useEffect(() => {
		const loadData = () => {
			...
			if (account?.address) {
				const userPositions = liquidityMiningService.getUserStakingPositions(
					account.address,
				);
				const userStats = liquidityMiningService.getUserStakingStats(
					account.address,
				);
				const history = liquidityMiningService.getUserClaimHistory(
					account.address,
				);
