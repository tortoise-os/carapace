...
export const metadata: Metadata = {
  ...
  description:
    "Experience the future of DeFi with AI-powered adaptive fees and intelligent yield optimization on Sui blockchain",
}
              ...
              <header className="glass sticky top-0 z-50 w-full border-b">
                <div className="container flex h-16 items-center justify-between px-4 max-w-7xl mx-auto">
                  <Link href="/" className="flex items-center gap-3 group">
                    ...
                    <div>
                      <h1 className="text-lg font-bold tracking-tight">TortoiseSwap</h1>
                      <p className="text-[10px] text-brand-gradient font-semibold leading-none">
                        AI-Powered DEX
                      </p>
                    </div>
                  </Link>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                      ...
                      <p className="text-sm text-muted-foreground max-w-md">
                        AI-powered DEX on Sui blockchain. Trade smarter with adaptive fees and
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li>
                          <Link href="/swap" className="hover:text-primary transition-colors">
                            Swap
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link href="/positions" className="hover:text-primary transition-colors">
                            Positions
                          </Link>
                        </li>
                        <li>
