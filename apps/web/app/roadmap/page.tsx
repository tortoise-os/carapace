...
import { BlurFade, BorderBeam, Card, DotPattern, MagicCard } from "@carapace/carapace-ui"
...
const ROADMAP: Feature[] = [
  // P1 - High Priority (Core Features) - ALL COMPLETED
  {
    ...
    status: "completed",
    description: "Core AMM swap functionality with real-time quotes",
    priority: "P1",
  },
  {
    name: "Liquidity Pool Management",
    status: "completed",
    description: "Add/remove liquidity with LP token tracking",
    priority: "P1",
  },
  {
    name: "Pool Creation",
    status: "completed",
    description: "Create new trading pairs with custom fee tiers",
    priority: "P1",
  },
  {
    name: "Real-time Price Feeds",
    status: "completed",
    description: "Pyth Network integration for accurate pricing",
    priority: "P1",
  },
  {
    name: "Wallet Integration",
    status: "completed",
    description: "Sui wallet support with balance tracking",
    priority: "P1",
  },
  {
    name: "Transaction Management",
    status: "completed",
    description: "Sign and execute transactions on Sui",
    priority: "P1",
  },
  {
    name: "Pool Analytics",
    status: "completed",
    description: "TVL, volume, and APR calculations",
    priority: "P1",
  },
  {
    name: "Price Impact Warnings",
    status: "completed",
    description: "Real-time slippage and impact alerts",
    priority: "P1",
  },

  // P2 - Medium Priority (Enhanced UX) - ALL COMPLETED
  {
    name: "Advanced Slippage Settings",
    status: "completed",
    description: "4-tier warning system with transaction deadlines",
    priority: "P2",
  },
  {
    name: "Transaction History",
    status: "completed",
    description: "Full history with filtering and statistics",
    priority: "P2",
  },
  {
    name: "Wallet Balance Widget",
    status: "completed",
    description: "Multi-token balance display with USD values",
    priority: "P2",
  },
  {
    name: "Recent Transactions Widget",
    status: "completed",
    description: "Live transaction feed with auto-refresh",
    priority: "P2",
  },
  {
    name: "Liquidity Depth Charts",
    status: "completed",
    description: "Visual bid/ask depth with market indicators",
    priority: "P2",
  },
  {
    name: "User Settings Page",
    status: "completed",
    description: "Trading, display, and privacy preferences",
    priority: "P2",
  },
  {
    name: "Favorite Pools",
    status: "completed",
    description: "Star and filter your favorite trading pairs",
    priority: "P2",
  },
  {
    name: "Transaction Notifications",
    status: "completed",
    description: "Toast notifications for swap status updates",
    priority: "P2",
  },
  ...
  // P3 - Low Priority (Future Enhancements)
  {
    ...
    status: "completed",
    description: "Route through multiple pools for best prices",
    priority: "P3",
  },
  {
    name: "Limit Orders",
    status: "completed",
    description: "Set target prices for automatic execution",
    priority: "P3",
  },
  {
    name: "Portfolio Tracker",
    status: "completed",
    description: "Comprehensive portfolio analytics and insights",
    priority: "P3",
  },
  {
  ...
  },
  {
    ...
    status: "completed",
    description: "DAO voting and protocol parameter control",
    priority: "P3",
  },
  {
    name: "Mobile App",
...
export default function RoadmapPage() {
  ...
  const filteredFeatures =
    selectedPriority === "all" ? ROADMAP : ROADMAP.filter((f) => f.priority === selectedPriority)
  ...
  const p1Progress =
    (p1Features.filter((f) => f.status === "completed").length / p1Features.length) * 100
  const p2Progress =
    (p2Features.filter((f) => f.status === "completed").length / p2Features.length) * 100
  const p3Progress =
    (p3Features.filter((f) => f.status === "completed").length / p3Features.length) * 100
  const overallProgress =
    (ROADMAP.filter((f) => f.status === "completed").length / ROADMAP.length) * 100
