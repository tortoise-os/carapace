...
test.describe('Navigation', () => {
  ...
  test('should return to home when clicking logo', async ({ page }) => {
    ...
    // Click on logo/brand
    await page.getByRole('link', { name: /TortoiseSwap/ }).first().click();
  ...
  test('should display all navigation links', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'Pools', exact: true })).toBeVisible();
  ...
  test('should have consistent header across pages', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: /TortoiseSwap/ }).first()).toBeVisible();
