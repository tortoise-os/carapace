...
const envSchema = z.object({
  ...
  DATABASE_URL: z
    .string()
    .default("postgresql://carapace:carapace_dev_password@localhost:5432/carapace"),
...
export const config = {
  ...
  indexer: {
    ...
    batchSize: parseInt(env.INDEXER_BATCH_SIZE, 10),
    pollInterval: parseInt(env.INDEXER_POLL_INTERVAL, 10),
  },
}
