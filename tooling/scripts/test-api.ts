...
async function main() {
  ...
  const POOL_ID = '0x6828cc09b4466dd7753a457aaa8a328f32e189729b178ce38252a03ab8190951';
  ...
  try {
    ...
    if (quoteData.success) {
      ...
      console.log(`      Amount in: ${Number(quoteData.data.amountIn) / 1e9} SUI`);
      console.log(`      Amount out: ${Number(quoteData.data.amountOut) / 1e6} TEST`);
      console.log(`      Price impact: ${quoteData.data.priceImpact.toFixed(4)}%`);
